...
quint16 CcittCrc16::m_u16CrcTable[c_nCrcTableSize];

#define CRC_POLY_16             0xA001
#define CRC_POLY_32             0x04c11db7ul
#define CRC_POLY_32_INV         0xEDB88320ul   // inverted bit order
...
{
    for ( quint16 i = 0; i < c_nCrcTableSize; i++ )
    {
...
#ifdef DUMP_CRC_TABLE
    for ( int k = 0; k < c_nCrcTableSize; )
    {
        for ( int l = 0; l < 8; l++ )
        {
