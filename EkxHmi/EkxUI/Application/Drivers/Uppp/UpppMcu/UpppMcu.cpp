...
UpppLevel3Msg UpppMcu::sendSimulateAlarmCodeMsg( const bool bHopperDismounted,
                                                 ...
                                                 const bool bRotorLocked )
{
    ...
    u8SystemCode |= ( bHopperDismounted ? McuSystemStatusHopperDismounted : 0 );
    u8SystemCode |= ( bGrinderChamberOpen ? McuSystemStatusGrinderChamberOpen : 0 );
    msg << u8SystemCode;
...
void UpppMcu::processMcuStatus( const UpppCoreMsg & coreMsg )
{
    ...
    else
    {
        ...
        bool bHopperDismounted   = ( u8SystemStatus & McuSystemStatusHopperDismounted );
        bool bGrinderChamberOpen = ( u8SystemStatus & McuSystemStatusGrinderChamberOpen );
