 ...
 * @return CRC32 value
 */
uint32_t esp_rom_crc32_le( uint32_t        crc,
                           uint8_t const * buf,
                           uint32_t        len );
 ...
 * @return CRC16 value
 */
uint16_t esp_rom_crc16_le( uint16_t        crc,
                           uint8_t const * buf,
                           uint32_t        len );
 ...
 * @return CRC16 value
 */
uint16_t esp_rom_crc16_be( uint16_t        crc,
                           uint8_t const * buf,
                           uint32_t        len );
 ...
 * @return CRC8 value
 */
uint8_t esp_rom_crc8_le( uint8_t         crc,
                         uint8_t const * buf,
                         uint32_t        len );
 ...
 * @return CRC8 value
 */
uint8_t esp_rom_crc8_be( uint8_t         crc,
                         uint8_t const * buf,
                         uint32_t        len );
