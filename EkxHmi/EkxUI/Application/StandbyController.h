...
public:
    ...
    void setSettingsModeExitTimeout( const int nSeconds );

    bool suppressSettingsModeExitTimer() const;

    void setSuppressSettingsModeExitTimer( bool bSuppress );
...
public slots:
    ...
    void processSettingsModeExitTimeChanged();
...
private:
    ...
    QTimer             m_timerSettingsModeExitTrigger;

    bool               m_bStandbyActive { false };

    bool               m_bPreStandbyDimActive { false };

    bool               m_bSuppressSettingsModeExitTimer { false };
