...
#ifndef RadioButtonMenu_h
#define RadioButtonMenu_h
...
private:
    ...
    static RadioButtonMenuItem * cb_menuItemsAt( QQmlListProperty<RadioButtonMenuItem> * qlp,
                                                 int                                     idx );
