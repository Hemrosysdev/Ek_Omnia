...
Item
{
    ...
    function confirmSaveFunction()
    {
        ...
        if (entryType === SettingsStateEnum.SETTING_USER_CPC_STORE)
        {
            relateduser = SettingsSerializerEnum.StoreOwner;
        }
        else
        {
             relateduser = SettingsSerializerEnum.Technician;
        }
    ...
    PinScreen
    {
        ...
        storeOwnerLogin: entryType === SettingsStateEnum.SETTING_USER_CPC_STORE ? true : false
        loginNeeded: false;
    ...
    ConfirmScreen
    {
        ...
        enableCancel: true  //isInfoNotQuestion : false
        onUserConfirmed:
        {
            confirmSaveFunction();
        }
