...
Item
{
    ...
    property string actionInfoHeadline: swUpdateController.swUpdateHeadline
    property string actionInfoText: swUpdateController.swUpdateInfo
    property bool   showProgressBar: swUpdateController.showProgressBar
    property int    progressValue: swUpdateController.progressValue
    property int    progressBarAutoTimer: swUpdateController.progressBarAutoTimer
    ...
    {
        console.log( "onProgressBarAutoTimerChanged");
    ...
    Timer
    {
        ...
        property int maxTimeSec: swUpdateController.progressBarAutoTimer
        property double inc
        property double value

        onMaxTimeSecChanged:
        {
            console.log( "onMaxTimeSecChanged");
            value = 0
    ...
    Item
    {
        ...
        width: parent.width
        height: swUpdateController.showUpdateCompScreen ? idAcknowlegdeText.height : 0

        visible: swUpdateController.showUpdateCompScreen
        ...
        MouseArea
        {
            ...
            onClicked:
            {
                swUpdateController.userAcknowlegeCall();
            }
        }
    }
}
