...
Rectangle
{
    ...
    property string errorText: statistics.errorText;
    ...
    onPeriodMenuActiveChanged:
    {
        if(periodMenuActive)
        {
            //settingsStateMachine.buttonOkVisible = false;
            settingsStateMachine.buttonPreviousVisible = false;
            settingsStateMachine.navAvailable = false;
            titleBackup = settingsStateMachine.menuTitle;
            settingsStateMachine.menuTitle = "TIME PERIOD";
        }
        else
        {
            //settingsStateMachine.buttonOkVisible = true;
            settingsStateMachine.buttonPreviousVisible = true;
            settingsStateMachine.navAvailable = true;
            settingsStateMachine.menuTitle = titleBackup;
        }
    }
    ...
    Item
    {
        ...
        Text
        {
            ...
            text: statistics.periodChoices[statistics.periodChoicesIndex].key;
        }
        ...
        MouseArea
        {
            ...
            onClicked:
            {
                ...
                else
                {
                    ...
                    idPeriodMenu.selectedIndex = statistics.periodChoicesIndex;
                }
            }
        }
    }
    ...
    Rectangle
    {
        ...
        property int selectedIndex: statistics.periodChoicesIndex;
        ...
        ListView
        {
            ...
            model: statistics.periodChoices;
            delegate: Rectangle
            {
        ...
        EkxButton
        {
            ...
            {
                idRoot.periodMenuActive = false;
                statistics.periodChoicesIndex = idPeriodMenu.selectedIndex;
