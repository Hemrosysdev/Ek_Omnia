...
Item
{
    ...
    {
        if ( entryType === SettingStatesEnum.SETTING_SYSTEM_TEMP_UNIT )
        {
        ...
        else if ( entryType === SettingStatesEnum.SETTING_SYSTEM_START_OF_WEEK )
        {
            settingsSerializer.startOfWeekisSunNotMon = indexOfChoosenValue;
            settingsSerializer.saveSettings();
