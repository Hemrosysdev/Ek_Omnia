...
public:
    ...
    explicit StatisticsBoard(QQmlEngine* engine, SqliteInterface* sqlInterface, QObject *parent = nullptr);
...
private:
    ...
    static StatisticsBoardResult* cb_namesAt(QQmlListProperty<StatisticsBoardResult>* qlp, int idx);

    static int                    cb_periodChoicesCount(QQmlListProperty<RadioButtonMenuItem>* qlp);
    static RadioButtonMenuItem*   cb_periodChoicesAt(QQmlListProperty<RadioButtonMenuItem>* qlp, int idx);
...
private:
    ...
    QString                           m_errorText;
    bool                              m_choicesMenuVisible {false};
    bool                              m_queryIsOngoing {false};
    SqliteInterface*                  m_sqliteInterface;
    ...
    int                               m_periodChoicesIndex;

    int                               m_discUsageMaxHours;
