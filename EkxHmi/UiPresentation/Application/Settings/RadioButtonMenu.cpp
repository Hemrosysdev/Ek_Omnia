...
//int RadioButtonMenu::radioButtonMenuItem_typeId  = qmlRegisterUncreatableType<RadioButtonMenuItem>( "Statistics",
//                                                                                      1,
//                                                                                      0,
//                                                                                      "RadioButtonMenuItem",
//                                                                                      "RadioButtonMenuItem could not be registered" );

int RadioButtonMenu::radioButtonMenuItem_typeId = qmlRegisterType<RadioButtonMenuItem>("Statistics", 1,0, "RadioButtonMenuItem");
int RadioButtonMenu::radioButtonMenu_typeId = qmlRegisterType<RadioButtonMenu>("Statistics", 1,0, "RadioButtonMenu");
...
RadioButtonMenuItem* RadioButtonMenu::cb_menuItemsAt(QQmlListProperty<RadioButtonMenuItem> *qlp, int index)
{
    RadioButtonMenu* radioButtonMenu = reinterpret_cast<RadioButtonMenu*>(qlp->data);
