...
void FreeRtosTask::createTaskPinnedToCore( const int nCore )
{
    const BaseType_t rc = xTaskCreatePinnedToCore( &FreeRtosTask::taskCallback,
                                                   m_strName.c_str(),
                                                   m_u32StackSize,
                                                   this,
                                                   m_uPriority,
    ...
    if ( rc != pdPASS )
    {
        vlogError( "createTask(): xTaskCreatePinnedToCore failed (%d)", rc );
        ESP_ERROR_CHECK( ESP_FAIL );
    }
