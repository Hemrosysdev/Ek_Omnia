...
int8_t EspNvsValue::valueI8( const std::string & strKey,
                             const int8_t        i8Default )
{
...
int16_t EspNvsValue::valueI16( const std::string & strKey,
                               const int16_t       i16Default )
{
...
int32_t EspNvsValue::valueI32( const std::string & strKey,
                               const int32_t       i32Default )
{
...
uint8_t EspNvsValue::valueU8( const std::string & strKey,
                              const uint8_t       u8Default )
{
